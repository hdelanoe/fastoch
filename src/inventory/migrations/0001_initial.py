# Generated by Django 5.0.9 on 2024-09-24 10:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_type', models.CharField(choices=[('quantity', 'Quantity'), ('name', 'Name'), ('weight', 'Weight'), ('price', 'Price')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fournisseur', models.CharField(blank=True, max_length=20, null=True)),
